clear
clc
load small_ice_HWFET_results

figure(1);
mpg = small_ice_hwfet_optimization.GLOBAL.f_min_hist.c(:,2);
iter = small_ice_hwfet_optimization.GLOBAL.f_min_hist.iter;
plot(iter,mpg,'linewidth',8)
xlabel('Iterations')
ylabel('MPG'),grid
title('Small ice HWFET')
set(gca,'FontSize',15,'fontWeight','bold')
set(findall(gcf,'type','text'),'FontSize',22,'fontWeight','bold')

figure(2);
CO = small_ice_hwfet_optimization.GLOBAL.f_min_hist.c(:,3);
iter = small_ice_hwfet_optimization.GLOBAL.f_min_hist.iter;
...
figure(3);
HC = small_ice_hwfet_optimization.GLOBAL.f_min_hist.c(:,4);
iter = small_ice_hwfet_optimization.GLOBAL.f_min_hist.iter;
...
figure(4);
NOx = small_ice_hwfet_optimization.GLOBAL.f_min_hist.c(:,5);
iter = small_ice_hwfet_optimization.GLOBAL.f_min_hist.iter;
...
fprintf('\nICE')
trq = small_ice_hwfet_optimization.GLOBAL.f_min_hist.x(:,1);
spd = small_ice_hwfet_optimization.GLOBAL.f_min_hist.x(:,2);
...
fd = small_ice_hwfet_optimization.GLOBAL.f_min_hist.x(:,3);
