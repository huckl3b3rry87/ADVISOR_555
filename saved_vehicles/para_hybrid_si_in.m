% para_hybrid_si_in.m  ADVISOR 2003  input file created: 02-Jun-2003 13:54:03

global vinf 

vinf.name='para_hybrid_si_in';
...
vinf.variables.name{8}='fc_trq_scale';
vinf.variables.value(8)=1.075;
