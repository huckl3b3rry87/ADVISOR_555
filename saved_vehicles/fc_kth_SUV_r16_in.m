% fc_kth_vehicle_r16_in.m  ADVISOR 2003  input file created: 27-Mar-2003 12:03

global vinf 

vinf.name='fc_kth_vehicle_r16_in';
...
vinf.variables.name{14}='fc_base_mass';
vinf.variables.value(14)=150;
vinf.variables.default(14)=125;
vinf.variables.name{15}='fc_acc_mass';
vinf.variables.value(15)=100;
vinf.variables.default(15)=25;
vinf.variables.name{16}='fc_fuel_mass';
vinf.variables.value(16)=100;
vinf.variables.default(16)=73.3843;
vinf.variables.name{17}='ess_cap_scale';
vinf.variables.value(17)=2;
vinf.variables.default(17)=1;
vinf.variables.name{18}='ess_module_num';
vinf.variables.value(18)=30;
vinf.variables.default(18)=0;
vinf.variables.name{19}='cs_fc_on';
vinf.variables.value(19)=1;
vinf.variables.default(19)=0;
