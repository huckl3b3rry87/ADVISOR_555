% Focus_in.m  ADVISOR 3.1  input file created: 17-Apr-2001 11:53:16

global vinf 

vinf.name='Focus_in';
vinf.drivetrain.name='ev';
vinf.motor_controller.name='MC_AC150_Focus_draft';
vinf.energy_storage.name='ESS_PB65_FocusEV';
