% small_ice_hwfet_in.m  ADVISOR 2003-00-r0116 input file created: 18-Mar-2014 06:08:50
...
vinf.variables.value(5)=1.8227;
vinf.variables.default(5)=1;
vinf.variables.name{6}='acc_mech_pwr';
vinf.variables.value(6)=700;
vinf.variables.default(6)=700;
vinf.variables.name{7}='fd_ratio';
vinf.variables.value(7)=0.69445;
vinf.variables.default(7)=1;
vinf.variables.name{8}='fc_spd_scale';
vinf.variables.value(8)=0.87243;
