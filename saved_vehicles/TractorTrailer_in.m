% TractorTrailer_in.m  ADVISOR 2002  input file created: 04-Apr-2002 09:51:36

global vinf 

vinf.name='TractorTrailer_in';
vinf.drivetrain.name='conventional';
vinf.fuel_converter.name='FC_CI330';
...
vinf.wheel_axle.name='WH_TractorTrailer_midRR';
vinf.wheel_axle.ver='Crr';
vinf.wheel_axle.type='Crr';
vinf.vehicle.name='VEH_KENT800Trailer';
