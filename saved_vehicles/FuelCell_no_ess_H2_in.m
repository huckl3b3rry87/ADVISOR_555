%------------------------------------------------------------
% Input vehicle file: FuelCell_no_ess_H2_in.m  
% File created: 04/04/02
%-------------------------------------------------------------
global vinf 

vinf.name='FuelCell_no_ess_H2_in';
vinf.drivetrain.name='fuel_cell';
vinf.fuel_converter.name='FC_KTH';
vinf.fuel_converter.ver='fcell';
vinf.fuel_converter.type='KTH';
...
%--------------------------------------------------------------------------------------------------------------------
% Revision history:
%05/14/02 kh: changed name of fuel converter m-file to FC_KTH