...
% dv_names={'fc_trq_scale','fc_spd_scale','mc_trq_scale','ess_module_num','gc_trq_scale','fd_ratio','ess_cap_scale','cs_hi_soc','cs_lo_soc'};
...
% x_U=[(1.5*fc_trq_scale),   (1.5*fc_spd_scale),    1.5*mc_trq_scale,    1.5*ess_module_num,       1.5*gc_trq_scale,  1.5*fd_ratio]';
%  
% max_P = max(fc_max_trq.*fc_map_spd);
% % % fc_trq_scale               fc_spd_scale         mc_trq_scale              ess_module_num          gc_trq_scale        fd_ratio   ess_cap_scale     cs_hi_soc    cs_lo_soc    cs_max_pwr    cs_min_pwr
% x_L=[(0.5*fc_trq_scale), (0.5*fc_spd_scale),    0.5*mc_trq_scale,          (0.5*ess_module_num),  0.5*gc_trq_scale,   0.5*fd_ratio,    0.5,               0.6,        0.2]';
% x_U=[(1.5*fc_trq_scale), (1.5*fc_spd_scale),    1.5*mc_trq_scale,          (1.5*ess_module_num),  1.5*gc_trq_scale,   1.5*fd_ratio,    1.5,                1,         0.6]';
...
% % % fc_trq_scale               fc_spd_scale         mc_trq_scale              ess_module_num          gc_trq_scale        fd_ratio   ess_cap_scale     cs_hi_soc    cs_lo_soc    cs_max_pwr    cs_min_pwr
% x_L=[(0.5*fc_trq_scale), (0.5*fc_spd_scale),    0.5*mc_trq_scale,          (0.5*ess_module_num),  0.5*gc_trq_scale,   0.5*fd_ratio,    0.5,               0.6,        0.2,       0.5*max_P,   0.5*max_P]';
% x_U=[(1.5*fc_trq_scale), (1.5*fc_spd_scale),    1.5*mc_trq_scale,          (1.5*ess_module_num),  1.5*gc_trq_scale,   1.5*fd_ratio,    1.5,                1,         0.6,       1.5*max_P,   1.5*max_P]';
