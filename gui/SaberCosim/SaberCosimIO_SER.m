function [InputSaberParams,OutputSaberValues,ModelPath,SaberModelName]=SaberCosimIO_SER(TempPath,t)
...
% EngineTrqParams=GetIOParamList('in','engine_trq');
EngineRPMParams=GetIOParamList('in','engine');
...
GCRegParams=GetIOParamList('in','gc_reg');
MotorParams=GetIOParamList('in','motor');

InputSaberParams={MCParams{:},...
        EngineRPMParams{:},...
        'ind_generator.ind_generator1 = max_torque_avail = ',...
...
if strcmp(EssType,'Saber pb') & strcmp(Ess2Type,'Saber pb')
    SaberModelName='Saber_Advisor_series_cosim'; 
elseif strcmp(EssType,'rint') & strcmp(Ess2Type,'Saber pb')
    SaberModelName='Saber_Advisor_series_rint_cosim'; 
elseif strcmp(EssType,'rint') & strcmp(Ess2Type,'rint')
    SaberModelName='Saber_Advisor_series_2rint_cosim';
elseif strcmp(EssType,'Saber pb') & strcmp(Ess2Type,'rint')
    SaberModelName='Saber_Advisor_series_rint2nd_cosim';
end
