...
dv_names={'fc_pwr_scale','mc_trq_scale','ess_module_num','fd_ratio','ess_cap_scale','cs_charge_trq','cs_min_trq_frac','cs_off_trq_frac','cs_electric_launch_spd_lo','cs_electric_launch_spd_hi','cs_charge_deplete_bool'};
...
x_L=[0.5*fc_pwr_scale, 0.5*mc_trq_scale,   round(0.5*ess_module_num),   0.5*fd_ratio,    0.5,             1,                 0.4,               0.1,                0,                          10,                        0]';
x_U=[1.5*fc_pwr_scale, 1.5*mc_trq_scale,   round(1.5*ess_module_num),   1.5*fd_ratio,    1.5,      1.5*max(fc_max_trq),      0.9,               0.5,                15,                         30,                        1]';
