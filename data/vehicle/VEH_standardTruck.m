% ADVISOR data file:  VEH_standardTruck.m
%
% Data source:
%
% Data confirmation:
...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
veh_description='Real standard truck';
...
disp(['Data loaded: VEH_standardTruck - ',veh_description])
...
%		The actual average vehicle mass of this standard truck is 1925 kg.
%		The glider mass below is just an estimate.
veh_glider_mass=1247; % (kg), vehicle mass w/o propulsion system (fuel converter, exhaust aftertreatment, transmission)
veh_CD=0.44;  % (--), estimated coefficient of aerodynamic drag
veh_FA=2.8;    % (m^2), frontal area
% Note: FWF set to 1-FWF and CG height set to negative to simulate rear-wheel drive
...
veh_wheelbase=3.53;	% (m), vehicle wheelbase, from center of front tire patch to center of rear patch.
