% ADVISOR data file:  VEH_compact.m
%
% Data source:
%
% Data confirmation:
...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
veh_description='Real compact car';
...
disp(['Data loaded: VEH_compact - ',veh_description])
...
%		The actual average vehicle mass of this compact car is 1418 kg.
...
veh_wheelbase=2.67;	% (m), vehicle wheelbase, from center of front tire patch to center of rear patch.
