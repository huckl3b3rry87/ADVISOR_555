...
veh_glider_mass=396; % (kg), vehicle mass w/o propulsion system (fuel converter,
                     % exhaust aftertreatment, drivetrain, motor, ESS, generator)
veh_CD=0.18;  % (--), coefficient of aerodynamic drag
veh_FA=1.7;    % (m^2), frontal area
...
veh_cargo_mass=280; %kg  cargo mass
