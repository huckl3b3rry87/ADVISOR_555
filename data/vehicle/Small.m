...
veh_glider_mass=914; % (kg), vehicle mass w/o propulsion system (fuel converter,
                     % exhaust aftertreatment, drivetrain, motor, ESS, generator)
veh_CD=0.22;  % (--), coefficient of aerodynamic drag
veh_FA=1.8;    % (m^2), frontal area
...
veh_cargo_mass=100; %kg  cargo mass
