% ADVISOR data file:  VEH_midsizecar.m
%
% Data source:
%
% Data confirmation:
%
% Notes:  Defines road load parameters for a real midsize car.
% 
% Created on: 10/03/02
...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
veh_description='Real mid-size car';
...
disp(['Data loaded: VEH_midsizecar - ',veh_description])
...
%		The actual average vehicle mass of this compact car is 1480 kg.
%		The glider mass below is just an estimate.
veh_glider_mass=1074; % (kg), vehicle mass w/o propulsion system (fuel converter, exhaust aftertreatment, transmission)
...
veh_wheelbase=2.71;	% (m), vehicle wheelbase, from center of front tire patch to center of rear patch.
