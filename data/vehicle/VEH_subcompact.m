% ADVISOR data file:  VEH_subcompact.m
%
% Data source:
%
% Data confirmation:
%
% Notes:  Defines road load parameters for a real subcompact car.
% 
% Created on: 10/03/02
...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
veh_description='Real subcompact car';
...
disp(['Data loaded: VEH_subcompact - ',veh_description])
...
%		The actual average vehicle mass of this subcompact car is 1485 kg.
%		The glider mass below is just an estimate.
veh_glider_mass=852; % (kg), vehicle mass w/o propulsion system (fuel converter, exhaust aftertreatment, transmission)
veh_CD=0.38;  % (--), coefficient of aerodynamic drag
...
veh_wheelbase=2.57;	% (m), vehicle wheelbase, from center of front tire patch to center of rear patch.
