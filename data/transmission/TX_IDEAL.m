...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
gb_version=2003;
gb_description=['Ideal (100% eff) gearbox loss file'];
...
disp(['Data loaded: TX_IDEAL - ',gb_description])
...
%gb_loss_const=0;
% 6-Jul-2001: mpo> changing from equation form of transmission efficiency to lookup table form
