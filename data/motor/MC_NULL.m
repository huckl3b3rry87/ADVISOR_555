...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
mc_description='Null Motor/Controller File';
...
disp(['Data loaded: MC_NULL - ',mc_description]);
...
% added tm:7/24/00
mc_eff_map=ones(size(mc_eff_map));
% end added tm:7/24/00
...
mc_mass=0;  % (kg), mass of motor and controller																			

% motor/controller thermal model 
%mc_th_calc=1;                             % --     0=no mc thermal calculations, 1=do calc's
mc_th_calc=0;                             % --     0=no mc thermal calculations, 1=do calc's
...
% REVISION HISTORY
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 7/24/00 file created based on mc_ac75
