% ADVISOR Data file:  MC_AC75_IDEAL.m
%
% Data source:  
%
...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
mc_description='Ideal (100% eff) Motor/Controller File';
...
disp(['Data loaded: MC_AC75_IDEAL - ',mc_description]);
...
% 12/20/00:tm updated to represent 100% efficienct system
