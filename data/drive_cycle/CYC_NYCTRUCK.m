% ADVISOR data file:  CYC_NYCTRUCK.m
%
...
% Data confirmation:
%
% Notes: Representitive of a heavy vehicle drive 
...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cyc_description='New York City Truck Driving Schedule';
...
disp(['Data loaded: CYC_NYCTRUCK - ',cyc_description])
...
cyc_cargo_mass=0; % no change in cargo mass associated with this cycle
