% ADVISOR data file:  CYC_ARTERIAL.m
%
...
% Data confirmation:
%
% Notes: Arterial test cycle (from SAE J1376).
% 
% 
...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cyc_description='ARTERIAL Driving Schedule';
...
disp(['Data loaded: CYC_ARTERIAL - ',cyc_description])
...
% 1/22/01: mpo created file from CYC_CBDBUS and updated to version 3.1
