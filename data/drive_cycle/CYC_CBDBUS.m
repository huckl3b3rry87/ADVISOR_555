% ADVISOR data file:  CYC_CBDBUS.m
%
...
% Data confirmation:
%
% Notes: Central Business District test cycle for buses.
% 
% 
% Created on: 10/23/98
% By:  TM of NREL
...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cyc_description='Central Business District Bus Driving Schedule';
...
disp(['Data loaded: CYC_CBDBUS - ',cyc_description])
