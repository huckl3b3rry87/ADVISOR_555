% ADVISOR data file:  CYC_UNIF01.m
%
% Data source:
% Engineers at Argonne National Lab.
%
% Data confirmation:
%
% Notes:
% This cycle was developed by Sierra Research for the California Air Resources
% Board and is a modified form of the LA92.
% 
...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cyc_description='Developed by Sierra Research for CARB';
...
disp(['Data loaded: CYC_UNIF01 - ',cyc_description])
