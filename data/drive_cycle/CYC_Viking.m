% ADVISOR data file:  CYC_Viking.m
%
% The Viking Freight Cycle for Heavy Vehicles. Developed by West Virginia
% University, this cycle was part of the Viking Freight CNG Truck On-Road
...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cyc_description='The Viking Freight Cycle';
...
load CYC_Viking; % contains cyc_mph
