...
% The Air Resources Board LA92 Dynamometer Driving Schedule, often called 
% the Unified driving schedule, was developed as an emission inventory 
% improvement tool. Compared to the FTP, the LA92 has a higher top speed, 
% a higher average speed, less idle time, fewer stops per mile, and a 
% higher maximum rate of acceleration. 
% 
% Created on: 5/5/00
...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cyc_description='CARB LA92 Dynamometer Driving Schedule';
...
cyc_validation=1; % 0=> no validation, 1=> data agrees with source data, 
% 2=> data matches source data and data collection methods have been verified
disp(['Data loaded: CYC_LA92 - ',cyc_description])
