...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cyc_description='60 mph(96.5 km/h) for 1 hour, then 36-h soak';
...
disp(['Data loaded: CYC_60MPH - ',cyc_description])
...
cyc_mph(1:t_tot,1)=[0:t_tot-1]';
cyc_mph(1:t_on,2)=mph*ones(t_on,1);
cyc_mph(t_on+1:t_tot,2)=zeros(t_off,1);
cyc_mph(1,2)=0;
cyc_mph(2,2)=0;
cyc_mph(3,2)=5;
cyc_mph(4,2)=10;
...
cyc_mph(11,2)=37;
cyc_mph(12,2)=39;
temp=[ones(t_on,1);zeros(t_off,1)];
vc_key_on=[cyc_mph(:,1),temp];
clear temp t_on t_off t_tot mph
