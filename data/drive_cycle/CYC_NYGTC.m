% ADVISOR data file:  CYC_NYGTC.m
%
% Data source:
% http://www.cemr.wvu.edu/~wwang/thdvetl/cycle/cycnygtc.htm
% Cycle entered using image2map function.
%
% Data confirmation:
% none 
%
% Notes:
% This data represents the New York Garbage Truck Cycle
% 
% Created on: 22-August-2001
% By: Michael O'Keefe, NREL
%
...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cyc_description='New York City Garbage Truck Cycle';
...
disp(['Data loaded: CYC_NYGTC- ',cyc_description])
...
% 8/22/01: mpo created from cyc_skeleton