% ADVISOR data file:  CYC_CBDTRUCK.m
%
...
% Data confirmation:
%
% Notes: Central Business District test cycle for trucks.
% 
% 
% Created on: 10/23/98
% By:  TM of NREL
...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cyc_description='Central Business District Truck Driving Schedule';
...
disp(['Data loaded: CYC_CBDTRUCK - ',cyc_description])
