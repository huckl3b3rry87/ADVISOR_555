% ADVISOR data file:  CYC_NewYorkBus.m
%
% Data source:
% Cycles provided by West Virginia University.
%
% Data confirmation:
% 
%
% Notes:
% [The following direct quote from draft report of 'Emissions Results 
% from Hybrid-Electric and Conventional Transit Buses in New York City',
% 19 Sept. 2000 by Clark et. al.]:
% "The New York Bus cycle was developed from speed-time data collected
% from heavy duty vehicles (both trucks and transit buses) in New York
% City. ..."
% 
% Created on: 29_Sept_2000
...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cyc_description='New York Bus Cycle';
...
disp(['Data loaded: CYC_NewYorkBus- ',cyc_description])
...
% 9/29/00:mpo New York Bus cycle created from cyc_skeleton
