% ADVISOR data file:  CYC_WVUCITY.m
%
...
% represents typical city driving for a heavy vehicle. 
% 
% Created on: 10/23/98
% By:  TM of NREL
%
...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cyc_description='West Virginia City Driving Schedule';
...
disp(['Data loaded: CYC_WVUCITY - ',cyc_description])
