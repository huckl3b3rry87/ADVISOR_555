% ADVISOR Filename:  CYC_UDDSHDV.M
%
% Data source: Code of Federal Regulations (1995). Title 40, Part 86, 
% Appendix I, Table D, p.1167-1175.
%
% Notes: EPA Urban Dynamometer Driving Schedule for Heavy-Duty Vehicles.
%
% Created: 06/02/98
% By: Tony Markel, National Renewable Energy Laboratory, Tony_Markel@nrel.gov
%
% File Revision history at end of file
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cyc_description='EPA Urban Dynamometer Driving Schedule for Heavy-Duty Vehicles';
...
disp(['Data loaded: CYC_UDDSHDV - ',cyc_description])
...
% REVISION HISTORY
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 10/21/98:tm file created
% 3/15/99:ss updated *_version to 2.1 from 2.0
% 11/3/99:ss updated version to 2.21
% 12/30/99: ss *.MAT is now *.mat so it runs in Unix
