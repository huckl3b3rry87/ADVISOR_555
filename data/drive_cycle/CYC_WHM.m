% ADVISOR data file:  CYC_WHM.m
%
% The William H. Martin Drive Cycle for Refuse Haulers
%
...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cyc_description='William H. Martin Refuse Hauler Drive Cycle';
