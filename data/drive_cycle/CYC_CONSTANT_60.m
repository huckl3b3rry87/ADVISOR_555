% ADVISOR data file:  CYC_CONSTANT_60.m
%
% Data source: Valerie Johnson, NREL
%
% Data confirmation:
%
% Notes: Requests a constant 60 mph speed of the vehicle for 50s.
% 
...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cyc_description='Constant 60 mph speed cycle';
...
disp(['Data loaded: CYC_CONSTANT_60 - ',cyc_description])
