% ADVISOR data file:  CYC_OCRef.m
%
% Developed by West Virginia University, this cycle was part of the Waste
% Management CNG Refuse Hauler On-Road Prototype Development Project.  
% http://www.ctts.nrel.gov/heavy_vehicle/waste_manage_orange.html (refuse
% haulers)
%
% Created on: 22 Sept. 2003
% By: Michael O'Keefe, michael_okeefe@nrel.gov
%
...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cyc_description='The Orange County Refuse Cycle';
...
disp(['Data loaded: ',mfilename,'- ',cyc_description])
...
load CYC_OCRef; % contains cyc_mph
