...
% This data is indicative of a medium rolling resistance production tire measured by Michelin.
% Rolling resistance data for use with the J2452 rolling resistance model provided by Michelin.
% Tire Size: P235/70R16
% Example Vehicle Application: Mazda Tribute LX
...
disp(['Data loaded: WH_P235_70R16_MED_RR - ',wh_description])

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Rolling Resistance Data
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Medium rolling resistance tire parameters:
...
% OTHER DATA		
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
wh_radius=0.355;    % (m), tire rolling radius 
                    
% (m), Tire Size: P235/70R16 
% tire diameter = (2*235*0.70)+ 16"(25.4)= 735.4 mm
% average P235/70R16 tire spec's: 722 rev/mile at 45 mph loaded
