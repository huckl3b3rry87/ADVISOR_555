% ADVISOR data file:  WH_TractorTrailer_lowRR.m
%
...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
wh_description='Wheel/axle assembly for a Tractor Trailer Truck (low rolling resistance tires)';
...
disp(['Data loaded: WH_TractorTrailer_lowRR - ',wh_description])
...
wh_mass=80*18; % (kg), assume 80 kg/tire times 16 tires [ref. SAE 2000-01-3432]

% the source for the rolling resistance data is in hvy_veh_tires.html of the advisor/documentation directory
rrc0_steer=0.00447; % (N/N) Force of rolling resistance per force of loading (wheel/axle loading/weighting), 315/80R22.5 low rr
rrc0_drive= 0.00528;% (N/N) Force of rolling resistance per force of loading (wheel/axle loading/weighting), 275/80R22.5 (low RR)
rrc0_trailer= 0.00419;% (N/N) Force of rolling resistance per force of loading (wheel/axle loading/weighting), 275/80R22.5 (low RR)
