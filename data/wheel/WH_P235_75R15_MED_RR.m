...
% Example Vehicle Application: Dodge Dakota
...
disp(['Data loaded: WH_P235_75R15_MED_RR - ',wh_description])
...
% OTHER DATA		
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
wh_radius=0.352;    % (m), tire rolling radius 
                    
% (m), Tire Size: P235/75R15 
% tire diameter = (2*235*0.75)+ 15"(25.4)= 733.5 mm
% average P235/75R15 tire spec's: 728 rev/mile at 45 mph loaded
