...
disp(['Data loaded: WH_SUVJ2452 - ',wh_description])

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Rolling Resistance Data
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
veh_rr_alpha = -0.3191; % Example tire parameters
veh_rr_beta = 0.9076;
veh_rr_a = 0.123;
veh_rr_b = 0.000196;
veh_rr_c = 1.52E-06;
...
% OTHER DATA		
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
wh_radius=0.343;    % (m), rolling radius of 13.5" tire
