...
%
% Notes:
% Defines tire, wheel, and axle assembly parameters for use with ADVISOR 2002+, for
% the SAE J2452 type of rolling resistance model provided by Michelin.
% Tire Size: P205/60R15
% Example Vehicle Application: Mazda 626
...
disp(['Data loaded: WH_P205_60R15_LO_RR - ',wh_description])

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Rolling Resistance Data
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
veh_rr_alpha = -0.4243; % Example tire parameters
veh_rr_beta = 0.9568;
veh_rr_a = 0.159;
veh_rr_b = 3.44E-04;
veh_rr_c = 1.25E-06;
...
% OTHER DATA		
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
wh_radius=0.304;    % (m), rolling radius of 15" tire

% (m), Tire Size: P205/60R15 
% tire diameter = (2*205*0.60)+ 15"(25.4)= 647.5 mm
% wh_radius = tire diameter/2 - squish (assumed squish of 10 mm)
...
% mass of tire alone is 10.55 (kg)
wh_mass=0;
