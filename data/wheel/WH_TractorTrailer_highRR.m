% ADVISOR data file:  WH_TractorTrailer_highRR.m
%
...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
wh_description='Wheel/axle assembly for a Tractor Trailer Truck (higher rolling resistance tires)';
...
wh_mass=80*18; % (kg), assume 80 kg/ea. tire&wheel assembly times 16 tires [ref. SAE 2000-01-3432]

% the source for the rolling resistance data is in hvy_veh_tires.html of the advisor/documentation directory
rrc0_steer=0.00626; % (N/N) Force of rolling resistance per force of loading (wheel/axle loading/weighting), 315/80R22.5 (mid RR)
rrc0_drive= 0.00744;% (N/N) Force of rolling resistance per force of loading (wheel/axle loading/weighting), 275/80R22.5 (mid RR)
rrc0_trailer= 0.00579;% (N/N) Force of rolling resistance per force of loading (wheel/axle loading/weighting), 275/80R22.5 (mid RR)
