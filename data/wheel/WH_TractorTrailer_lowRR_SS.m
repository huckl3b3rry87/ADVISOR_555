% ADVISOR data file:  WH_TractorTrailer_lowRR_SS.m
%
...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
wh_description='Wheel/axle assembly for a Tractor Trailer Truck (uses low RR tires with super singles)';
...
disp(['Data loaded: WH_TractorTrailer_highRR - ',wh_description])
...
wh_radius=0.495;    % (m), rolling radius of the drive tires, 445/50R22.5 (super single) assumed
...
wh_mass=80*2+109*8; % (kg), assume 80 kg/ea. single tire&wheel assembly and 109 kg/ea. super single [ref. SAE 2000-01-3432]

% the source for the rolling resistance data is in hvy_veh_tires.html of the advisor/documentation directory
rrc0_steer=0.00447; % (N/N) Force of rolling resistance per force of loading (wheel/axle loading/weighting), 315/80R22.5 (mid RR)
rrc0_drive= 0.00454;% (N/N) Force of rolling resistance per force of loading (wheel/axle loading/weighting), 275/80R22.5 (mid RR)
rrc0_trailer= 0.00343;% (N/N) Force of rolling resistance per force of loading (wheel/axle loading/weighting), 275/80R22.5 (mid RR)
