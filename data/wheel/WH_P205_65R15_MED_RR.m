...
% Example Vehicle Application: Honda Accord LX
...
disp(['Data loaded: WH_P205_65R15_MED_RR - ',wh_description])
...
% OTHER DATA		
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
wh_radius=0.314;    % (m), tire rolling radius 
                    
% (m), Tire Size: P205/65R15 
% tire diameter = (2*205*0.65)+ 15"(25.4)= 647.5 mm
% average P205/65R15 tire spec's: 817 rev/mile at 45 mph loaded
