% ADVISOR Data file:  FC_CI119.M
%
% Data source:  Data interpreted from "Internal Combustion Engine Fundamentals"
% by John B. Heywood, page 859, Figure 15-21.
%
% Data confidence level:  no comparison has been performed
%
% Notes:  
% Engine performance map for a 6.54 L 8-cylinder air-cooled, naturally aspirated 
% DI Diesel engine. Data provided as g/kWh vs. RPM and Torque.
% Engine Specs.
% Bore - 102 mm
% Stoke - 100 mm
% Compression Ratio - 18
% Max rated power 119kW @ 3200 rpm 
% Peak Torque 400 Nm @ 2000 rpm
% Brake fuel conversion efficiency - 38.5%
% Gross indicated fuel conversion efficiency - 48%
%
% Created on:  07/01/98
...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
fc_description='6.5L (119kW) Diesel Engine'; % one line descriptor identifying the engine
...
fc_map_spd=[1000:500:3500]*2*pi/60; 

% (N*m), torque range of the engine
fc_map_trq=[120 140 180 220 260 300 340 380 420]; 
...
fc_fuel_map_gpkWh = [
250	242	230	225	224	224	225	225	225
250	243	231	226	222	220	222.5	226	226
254	248	235	228	225	221	222.5	226	226
260	255	241	234	228	226	226	228.5	228.5
270	264	256	245	238	235	236	236	236
280	275	270	263	255	249	247	246	246]; % (g/kW*hr)
...
fc_max_trq=[310 380 400 392 368 330]; 
