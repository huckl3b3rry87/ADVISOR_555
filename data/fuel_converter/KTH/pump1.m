%-------------------------------------------------------------------------------------------------
%
% M-file: pump1.m     (pump for the re-circulation of water)
% Revision history
...
%				001115
%---------------------------------------------------------------------------------------------------
function f=pump1(u,Tcond,g,dpipe,Lpipe,etapump)
...
Ppump1=(wcv*mW_out)/etapump;
p_81=p_61+deltap_pump;

%Output vector
%-------------
clear u
u=[m_W_re m_Wl_re m_Wg_re Ppump1 p_81];
f=u;
%----------------end pump1.m-------------------------------------------