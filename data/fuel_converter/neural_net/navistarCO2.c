/* Insert this code into your C program to fire the C:\NeuroShell 2\Nav Pos CO2 (04-05-02) network */
...
/* 
% Neural Network Mex file for Use with ADVISOR: navistarCO2.c
%
...
void navistarCO2(double *inarray, double *outarray)
{
 double netsum;
 double feature2[20];
 double feature3[20];
...
/** nlhs is the number of left-hand-side arguments
  ...
  for(i=0; i<ncols; i++)
  {
    ...
    /* Call the navistarCO2 function. */
    navistarCO2(&inarray[currIndex],&tmp);
...
/* 
to test:
out=navistarCO2([[60:70];diff([60:71]);diff([60:71]);[60:70];diff([60:71]);diff([60:71])]) 
*/