#ifndef navistarCOfunc_c
#define navistarCOfunc_c
/* Insert this code into your C program to fire the C:\NeuroShell 2\Nav Pos CO 
   (04-05-02) network */
...
/* 
% Neural Network Mex file for Use with ADVISOR: navistarCOfunc.c
%
...
void navistarCOfunc(double *inarray, double *outarray)
{
 double netsum;
 double feature2[20];
 double feature3[20];
