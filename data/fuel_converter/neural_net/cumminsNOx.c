/* Insert this code into your C program to fire the C:\NeuroShell 2\CmnsAllPosNOx 04-04-02 network */
...
/* 
% Neural Network Mex file for Use with ADVISOR: cumminsNOx.c
%
...
void cumminsNOx(double *inarray, double *outarray)
{
 double netsum;
 double feature2[20];
 double feature3[20];
...
/** nlhs is the number of left-hand-side arguments
  ...
  for(i=0; i<ncols; i++)
  {
    ...
    /* Call the cumminsNOx function. */
    cumminsNOx(&inarray[currIndex],&tmp);
...
/* 
to test:
out=cumminsNOx([[60:70];diff([60:71]);diff([60:71]);[60:70];diff([60:71]);diff([60:71])]) 
*/