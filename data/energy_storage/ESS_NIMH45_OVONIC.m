...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ess_description='Ovonic 45Ah NiMH HEV battery';
...
disp(['Data loaded: ESS_NIMH45_OVONIC - ',ess_description])
...
ess_r_dis=[2.135 1.155	1.086	1.011	0.990	0.970	0.958	0.981	1.050	1.125	1.071
...
% OTHER DATA
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ess_module_mass=8.4;  % (kg), mass of a single ~12 V module
ess_module_volume=0.340*0.074*0.135; % (m^3), length X width X height
...
ess_mass_scale_coef=[1 0 0.9832073 0.0160194]; % coefficients in ess_mass_scale_fun; updated tm:10/22/01 based on Ovonic family
...
ess_res_scale_coef=[1 0 0.8698015 0.1226830]; % coefficients in ess_res_scale_fun; updated tm:10/22/01 based on Ovonic family
...
ess_mod_sarea=2*(0.340*0.135+0.074*0.135);          % m^2    total module surface area exposed to cooling air (typ rectang module)
...
% 10/22/01:tm updated ess_cap_scale related coefficients in mass and resistance scaling functions based on Ovonic family of modules
