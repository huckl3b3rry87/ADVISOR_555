% ADVISOR data file:  ESS_PB69_14V_saber.m
%
% Data source:
% 
%
...
disp(['Data loaded: ESS_PB69_42V_saber - ',ess_description])
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ess_vehicletype=5;
% ess_ah_nom=69;	% A*hr: Nominal amp·hour capacity at tnom and inom. Must be specified consistent with inom and tend
...
ess_module_mass=((69/6)*(11.8/28)); % (kg), mass of a single cell (approximation based on ESS_PB28 capacity/mass ratio)

ess_ah_nom_fun=inline('69*ess_cap_scale');
