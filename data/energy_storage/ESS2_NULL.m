...
% also, set ess2_module_mass to 0.01 (do not set to 0 - some mass 
% required for thermal models) and set ess2_min_volts very low 
% and ess2_max_volts very high. All ess parameters in this file
% are based on the ess2_PB25 data file.
%
% Created on: 8/21/00
...
disp(['Data loaded: ESS2_NULL - ',ess2_description])
