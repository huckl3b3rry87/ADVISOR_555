% ADVISOR data file:  ESS_PB91_ucd.m    where 91 is c/5-rate capacity
%
% Data source:
...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ess_description='Horizon lead-acid battery tested at UC-Davis';
...
disp(['Data loaded: ESS_PB91_ucd - ',ess_description])
...
% OTHER DATA
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ess_module_mass=26.6;  % (kg), mass of a single ~12 V module
...
% 10/13/98:mc recomputed ess_max_ah_cap and renamed file (from ESS_PB86)
