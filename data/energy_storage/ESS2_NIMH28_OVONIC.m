...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ess2_description='Ovonic 28Ah NiMH HEV battery';
...
ess2_validation=1; % 0=> no validation, 1=> data agrees with source data, 
% 2=> data matches source data and data collection methods have been verified
disp(['Data loaded: ESS_NIMH28_OVONIC - ',ess2_description])
...
ess2_r_dis=[0.01266 0.00685	0.00644	0.00599	0.00587	0.00575	0.00568	0.00581	0.00623	0.00667  0.00635
...
% LIMITS
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ess2_min_volts=0.87*1.05*5; % (V), 0.87*105% safety factor volts time 5 cells
ess2_max_volts=1.65*0.95*5;% (V), 1.65*95% safety factor volts times 5 cells
...
% OTHER DATA
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ess2_module_mass=3.6;  % (kg), mass of a single ~6 V module 
ess2_module_volume=0.195*0.102*0.81; % (m^3), length X width X height
ess2_module_num=50;  %a default value for number of modules
...
ess2_mod_sarea=2*(0.195*0.081+0.102*0.081);          % m^2    total module surface area exposed to cooling air (typ rectang module)
...
ess2_mod_flow_area=0.005*2*(0.195+0.102);    % m^2    cross-sec flow area for cooling air per module (assumes 10-mm gap btwn mods)
