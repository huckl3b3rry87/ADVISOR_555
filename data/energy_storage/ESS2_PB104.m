...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ess2_description='GNB 12-EVB-1180 VRLA battery, manufacturer''s data';
...
disp(['Data loaded: ESS_PB104 - ',ess2_description])
...
% OTHER DATA
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ess2_module_mass=30;  % (kg), mass of a single ~12 V module
...
% 10/13/98:mc recomputed ess2_max_ah_cap and renamed file (from ESS_PB118)
