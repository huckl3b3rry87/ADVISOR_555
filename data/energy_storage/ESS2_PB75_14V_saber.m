...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ess2_vehicletype=5;
% ess2_ah_nom=75;	% A*hr: Nominal amp·hour capacity at tnom and inom. Must be specified consistent with inom and tend
ess2_rnom=0.020; % W	Nominal internal electrical resistance at tnom and "full charge"
ess2_sg_full=1.310; % Specific gravity at full charge at 25°C
ess2_sg_disc=1.025; % Specific gravity full discharge at 25°C
ess2_fah_thi=1.02; % Multiple of ah_nom at "high temperature" and inom (neglecting self discharge). Must be > 1 and < fah_max
ess2_fc=0.6; % Fraction of capacity "near plate". Must be 0 < fc < 1
ess2_fah_max=1.03; % Multiple of ah_nom capacity available at "slow" (i.e. < 0.01·inom) discharge and tnom. (neglecting self discharge). Must be > fah_thi
...
ess2_module_mass=((75/6)*(11.8/28)); % (kg), mass of a single cell (approximation based on ESS_PB28 capacity/mass ratio)

ess2_ah_nom_fun=inline('75*ess_cap_scale');
