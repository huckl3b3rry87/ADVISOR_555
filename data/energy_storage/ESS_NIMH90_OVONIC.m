...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ess_description='Ovonic 90Ah NiMH HEV battery';
...
disp(['Data loaded: ESS_NIMH90_OVONIC - ',ess_description])
...
ess_r_dis=[1.167 0.631	0.594	0.552	0.541	0.530	0.523	0.536	0.574	0.615	0.585
...
% OTHER DATA
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ess_module_mass=16.7;  % (kg), mass of a single ~12 V module
ess_module_volume=0.385*0.102*0.168; % (m^3), length X width X height
...
ess_mod_sarea=2*(0.385*0.168+0.102*0.168);          % m^2    total module surface area exposed to cooling air (typ rectang module)
