% ADVISOR data file:  ESS_PB18.m
%
% Data source:  Tests at NREL
% Manufacturer: Optima Batteries
%
% Data confirmation:
%
% Notes:
% This is a prototype of an Optima valve-regulated spiral-wound lead-acid battery
% that was developed as part of the DOE hybrid vehicle program.
% This data is not proprietary and was approved for public release
% on October 16,1998 by John Olsen of Optima.
%
% Data was collected at NREL in Summer, 1998 to generate the parameters in this model.
% 
% Created on: 17-Jul-1998
% By:  DJR, NREL, david_rausen@nrel.gov
%
...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ess2_description='Optima spiral-wound VRLA prototype battery';
...
disp(['Data loaded: ESS_PB18 - ',ess2_description])
...
ess2_r_dis=[
   0.090 0.030 0.020 0.015 0.015 0.015
   0.090 0.030 0.020 0.015 0.015 0.015
   0.090 0.030 0.020 0.015 0.015 0.015
]; % (ohm)
...
% OTHER DATA
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ess2_module_mass=6.680;                     % (kg),  mass of a single ~12 V module
