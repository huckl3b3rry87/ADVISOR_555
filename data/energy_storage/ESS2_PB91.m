% ADVISOR data file:  ESS_PB91.m    where 91 is c/5-rate capacity
%
% Data source:
% Manufacturer
%
...
%
% Notes:
% This models the Electrosource Horizon 12N85 lead-acid battery, which has
% specific energy of ~35 Wh/kg and specific power of ~240 W/kg.
% 
...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ess2_description='Horizon 12N85 lead-acid battery, manufacturer''s data';
...
disp(['Data loaded: ESS_PB91 - ',ess2_description])
