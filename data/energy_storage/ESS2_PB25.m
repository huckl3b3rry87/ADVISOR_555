...
%
% Notes:
% These parameters describe the Hawker Genesis 12V26Ah10EP sealed
...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ess2_description='Hawker Genesis 12V26Ah10EP VRLA battery, tested by VA Tech';
...
disp(['Data loaded: ESS_PB25 - ',ess2_description])
...
% REVISION HISTORY
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 6/30/98 (MC): converted from E_HAWKER.M
% 10/13/98:mc recomputed ess2_max_ah_cap and renamed file (from ESS_PB20)
