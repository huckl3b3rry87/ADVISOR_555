% ADVISOR data file:  PTC_FUZZY_FUEL_MODE.m
%
% Data source:
%
% Data confirmation:
...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ptc_description='Fuzzy Logic controller limiting instantaneous fuel usage';
...
disp(['Data loaded: PTC_FUZZY_FUEL_MODE - ',ptc_description])
  
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% CLUTCH & ENGINE CONTROL
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% engine idle speed
vc_idle_spd=73.3;  % (rad/s) 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% FUEL USE MODE
% Set the mode to limit fuel usage of the IC Engine
% 1=> FUEL LIMITING MODE; 0=> PEAK EFFIENCY MODE
cs_fuzzy_fuel_mode=1; % (--)

% For the Fuzzy Logic Strategy based on Fuel Use limit
cs_fuzzy_fuel_limit=2; % (ICE engine operation limited to this value, g/s) 
