% ADVISOR data file:  EX_SI.m
%
% Data source:
%
% Data confirmation:
%
% Notes:  CONVENTIONAL CONVERTER FOR AN SI ENGINE
...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ex_description='Standard catalyst for ~stoichiometric SI engine';
...
disp(['Data loaded: EX_SI - ',ex_description])
