% ADVISOR data file:  EX_CI_CC.m
%
% Data source:
%
% Data confirmation:
%
% Notes:  CLOSE-COUPLED CONVENTIONAL CONVERTER FOR A CI ENGINE
...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ex_description='CLOSE-COUPLED catalyst for CI engine';
...
disp(['Data loaded: EX_CI_CC - ',ex_description])
