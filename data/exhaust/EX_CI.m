% ADVISOR data file:  EX_CI.m
%
% Data source:
%
% Data confirmation:
%
% Notes:  CONVENTIONAL CONVERTER FOR A CI ENGINE
...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ex_description='Standard catalyst for CI engine';
...
disp(['Data loaded: EX_CI - ',ex_description])
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% CAT EFF VS TEMPERATURE catalyst's temperature-dependent conversion efficiencies indexed by ex_cat_tmp_range
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%ex_cat_temp_range=[-40 0 220 240 310 415 475 550 650 1200]; % (deg. C)
%ex_cat_hc_frac=[0 0 0 0 0.6 0.84 0.92 1 1 1]*0.85;  % (--) old data from MC SAE paper (SI engine)
