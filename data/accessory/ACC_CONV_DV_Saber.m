% ADVISOR data file:  ACC_CONV_DV_Saber.m
%
% Data source:
%
% Data confirmation:
...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
acc_description='Dual voltage electrical loads';
...
disp(['Data loaded: ACC_CONV_DV_Saber - ',acc_description])
...
acc_mech_model_name='Saber Dual Voltage Cosim';
