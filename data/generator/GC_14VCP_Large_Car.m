% ADVISOR data file:  GC_14VCP_Large_Car.m
%
% Data source:
% 
%
...
disp(['Data loaded: GC_14VCP_Large_Car - ',gc_description])

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% GENERATOR DATA
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
gc_vehicletype=1; %  	1	large car
		    	%   	2	medium car
				%   	3	small car
				%   	4	SUV
...
% DEFAULT SCALING
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
gc_mass=7; % (kg), mass of machine and controller, estimate based on one 24V generator linearly scaled by power to zero
